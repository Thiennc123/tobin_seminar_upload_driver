                        ...
                        <table class="table">
                            ...
                            @foreach ($listFile as $key => $file)
                                 <tr>
                                    ...
                                    <td>{{ $file }}</td>
                                    <td>
                                        <a type="button" class="btn btn-primary" href="{{ route('download', ['name' => $file]) }}">Download</a>
                                        <a type="button" class="btn btn-secondary" href="{{ route('delete', ['name' => $file]) }}">Remove</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
